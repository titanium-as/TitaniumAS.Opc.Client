...
namespace TitaniumAS.Opc.Client.Tests.Da.Browsing
{
    ...
    public class OpcDaBrowser2Tests
    {
        ...
        {
            OpcDaBrowseElement[] elements = _opcBrowser.GetElements("Random", new OpcDaElementFilter() { ElementType = OpcDaBrowseFilter.Items }, new OpcDaPropertiesQuery(true, OpcDaItemPropertyIds.OPC_PROP_VALUE));
            elements.Should().NotBeEmpty()
